...
#include <memory>
#include "../mobileBrowser/historymodel.h"
...
QT_MOC_LITERAL(18, 12) // "historyList*"

    },
    "historyModel\0list\0historyList*"
};
...
void historyModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::RegisterPropertyMetaType) {
        ...
        case 0:
            *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< historyList* >(); break;
        }
    }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< historyList**>(_v) = _t->list(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setList(*reinterpret_cast< historyList**>(_v)); break;
        default: break;
        }
...
, QtPrivate::TypeAndForceComplete<historyList*, std::true_type>, QtPrivate::TypeAndForceComplete<historyModel, std::true_type>
